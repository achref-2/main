...
const CVHistoryContent = () => {
  ...
  const fetchCVHistory = async () => {
    try {
        ...
        const data = JSON.parse(text); // Convertir seulement si c'est du JSON
      ...
      <div className="flex h-screen bg-white dark:bg-black">
        ...
        <main className="flex-1 overflow-auto bg-gray-50 dark:bg-black transition-all duration-300 ease-in-out z-30">
          ...
          <div className="p-6 space-y-6 transition-all duration-300 ease-in-out z-30">
            <div>
              <h1 className="text-2xl font-semibold text-gray-900 dark:text-white transition-all duration-300 ease-in-out z-30">Job History</h1>
              <p className="text-gray-500 dark:text-gray-400 transition-all duration-300 ease-in-out z-30">View and manage your JOB uploads</p>
            </div>
