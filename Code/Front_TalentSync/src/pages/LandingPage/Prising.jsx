...
function BackButton({ isExpanded }) {
  return (
    <a
      ...
      className="flex items-center p-2 rounded-lg text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-gray-100 transition-colors cursor-pointer"
    >
      <ArrowLeft size={20} />
...
function SupportButton({ href, icon: Icon, text }) {
  return (
    <a
      href={href}
      className="bg-gray-800/70 hover:bg-gray-700/70 text-gray-200 px-5 py-2 rounded-lg flex items-center gap-2 transition-all duration-200 border border-gray-700 hover:border-gray-600"
    >
      <Icon size={16} />
      <span>{text}</span>
    </a>
      ...
      <div className="flex h-screen bg-white dark:bg-gray-900">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-30">
            <div className="flex items-center justify-between px-4 py-3">
              <div className="flex items-center gap-3">
                ...
                {/* Breadcrumb */}
                <nav className="hidden sm:flex items-center text-sm text-gray-500 dark:text-gray-400">
          ...
          <main className="flex-1 overflow-auto bg-gray-50 dark:bg-gray-900">
            ...
            <div className="bg-gradient-to-b from-gray-900 to-gray-950 min-h-screen flex flex-col items-center justify-center px-4 py-16 relative overflow-hidden">
              {/* Background decorations */}
              <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-0 left-1/4 w-64 h-64 bg-blue-500 opacity-10 rounded-full filter blur-3xl"></div>
                <div className="absolute bottom-1/4 right-1/3 w-80 h-80 bg-purple-600 opacity-10 rounded-full filter blur-3xl"></div>
                <div className="absolute top-1/3 right-1/4 w-60 h-60 bg-indigo-500 opacity-10 rounded-full filter blur-3xl"></div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 w-full max-w-4xl relative z-10">
                {/* Support Card */}
                <div className="bg-gray-850 border border-gray-800 rounded-2xl overflow-hidden shadow-xl transform transition-all duration-300 hover:-translate-y-2 hover:shadow-indigo-500/20 hover:border-yellow-500/50 group">
                ...
                {/* Open Source Card */}
                <div className="bg-gray-850 border border-gray-800 rounded-2xl overflow-hidden shadow-xl transform transition-all duration-300 hover:-translate-y-2 hover:shadow-blue-500/20 hover:border-blue-500/50 group">
              ...
              {/* Testimonial */}
              <div className="mt-16 bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700 max-w-2xl relative z-10 transform transition hover:shadow-blue-500/10 hover:-translate-y-1">
                <div className="absolute -top-4 -left-4 text-gray-600 text-4xl opacity-30">
                  "
                </div>
                <div className="absolute -bottom-4 -right-4 text-gray-600 text-4xl opacity-30">
                  "
                </div>
